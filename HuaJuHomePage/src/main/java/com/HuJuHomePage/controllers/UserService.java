...
//
//	@Autowired
//	private com.HuJuHomePage.services.UserService userService;
//
//	/*
...
//	 */
////	public User userlogin(String student_ID, String password) {
////		user = userService.login(student_ID, password);
////		return user;
////	}
//
//
//	/*
//	 * 1.权限设置：
//	 * 组员权限只能预约往后2天（48小时）内的活动室；
//	 * 每7天最多预约3次，使用总时长不超过6小时。
//	 * 组长权限只能预约往后2周（14天）内的活动室；但对于预约次数和预约总时长无限制。
//	 * 2.预约时间段精度为1小时。预约最短时间为1小时，最长6小时。
//	 */
//
